...
class User(UserMixin, db.Model):
    ...
    deposits = db.Column(db.Text)  # JSON string para armazenar depósitos
...
class User(db.Model, UserMixin):
 ...
 """
"""
#Este arquivo define o modelo de dados para os usuários. Verifique se os campos, como username, password_hash e deposits, estão corretamente configurados e se a lógica de criptografia de senha (set_password e check_password) está correta.
